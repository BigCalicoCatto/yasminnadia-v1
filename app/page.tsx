    ...
    <div style={{ backgroundColor: '#ffffff', color: '#1a1a1a', fontFamily: 'Trebuchet MS, sans-serif' }}>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: '#ffffff', borderBottom: '1px solid #f0f0f0', padding: '1rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'center' }}>
          <a href="https://instagram.com/" style={{ color: '#FF6B9D', textDecoration: 'none', display: 'flex', alignItems: 'center', transition: 'opacity 0.3s', fontSize: '1.3rem' }}>
            <i className="fab fa-instagram"></i>
          </a>
          <a href="https://tiktok.com/" style={{ color: '#FF6B9D', textDecoration: 'none', display: 'flex', alignItems: 'center', transition: 'opacity 0.3s', fontSize: '1.3rem' }}>
